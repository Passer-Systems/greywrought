...
try {
  ...
  console.log('PASS vertical geometry, identities/portraits, slot editing, drag retiming, pinned preview/forecast, narrow viewport, Ready and interrupted action',page.output);
