...
try {
  ...
  await page.shot('entrance');await east(39);
  ...
  console.log('PASS Hollowdeep entry, two animated creatures, damage, corpse loot and exit',page.output);
