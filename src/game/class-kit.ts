...
function kit(movementTiles: number, movementSpeed: number, strike: Omit<ClassActionSpec, "name">, brace: Omit<ClassActionSpec, "name">): ClassKit {
  return { archetype: "warrior", movementTiles, movementSpeed, abilities: {
    bait: { name: "Move", icon: "assets/ui/icons/spells/mobility-boots.png", description: `Move up to ${movementTiles} tiles. Costs 1 stamina.`, cost: 1, range: movementTiles * COMBAT_CELL_SIZE, duration: .45 },
...
const kits: Readonly<Record<CharacterArchetype, ClassKit>> = {
  ...
  alchemist: { ...kit(3, 5.6, { icon: "assets/ui/icons/spells/poison-vial.png", description: "Throw a caustic vial.", damage: 8, range: 10, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/healing-cross.png", description: "Restore health and absorb damage.", block: 16, heal: 6, cost: 2 }), archetype: "alchemist" },
