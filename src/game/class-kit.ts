...
const kits: Readonly<Record<CharacterArchetype, ClassKit>> = {
  warrior: {
    ...
    abilities: {
      strike: { name: "Lunge", icon: "assets/ui/icons/spells/sword-strike.png", description: "Leap into a nearby enemy and strike.", damage: 9, range: 6.5, cost: 1, duration: .25 },
  ...
  mage: {
    ...
    abilities: {
      strike: { name: "Arcane Bolt", icon: "assets/ui/icons/spells/wand-bolt.svg", description: "A ranged wand bolt.", damage: 9, range: 10, cost: 1, duration: .25 },
  ...
  hunter: {
    ...
    abilities: {
      strike: { name: "Aimed Shot", icon: "assets/ui/icons/spells/bow-shot.svg", description: "A ranged bow shot.", damage: 9, range: 10, cost: 1, duration: .25 },
  ...
  alchemist: {
    ...
    abilities: {
      strike: { name: "Reagent Toss", icon: "assets/ui/icons/spells/poison-vial.png", description: "Throw a caustic vial from 10 metres for ranged damage.", damage: 8, range: 10, cost: 1, duration: .25 },
  ...
  artificer: {
    ...
    abilities: {
      strike: { name: "Rivet Shot", icon: "assets/ui/icons/spells/lightning-bolt.png", description: "Fire a clockwork rivet from 10 metres.", damage: 10, range: 10, cost: 1, duration: .25 },
