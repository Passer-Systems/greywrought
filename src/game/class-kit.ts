...
const kits: Readonly<Record<CharacterArchetype, ClassKit>> = {
  ...
  hunter: { ...kit("hunter", 4, 6, { icon: "assets/ui/icons/spells/bow-shot.svg", description: "Shoot within 10 metres. Moving at least one tile first adds 8 damage to your Attack that turn.", damage: 18, range: 10, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/defensive-shield.png", description: "Deflect incoming damage.", block: 24, cost: 0 }), archetype: "hunter" },
