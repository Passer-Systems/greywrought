...
const kits: Readonly<Record<CharacterArchetype, ClassKit>> = {
  warrior: { ...kit(2, 5.2, { icon: "assets/ui/icons/spells/sword-strike.png", description: "Strike an enemy within 5 metres.", damage: 18, range: MELEE_RANGE, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/defensive-shield.png", description: "Absorb incoming damage.", block: 24, cost: 2 }), archetype: "warrior" },
  mage: { ...kit(2, 5.2, { icon: "assets/ui/icons/spells/wand-bolt.svg", description: "Fire a ranged arcane bolt.", damage: 18, range: 10, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/protective-ward.png", description: "Raise an arcane barrier.", block: 24, cost: 2 }), archetype: "mage" },
  hunter: { ...kit(4, 6, { icon: "assets/ui/icons/spells/bow-shot.svg", description: "Fire a ranged shot.", damage: 18, range: 10, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/defensive-shield.png", description: "Deflect incoming damage.", block: 24, cost: 2 }), archetype: "hunter" },
  alchemist: { ...kit(3, 5.6, { icon: "assets/ui/icons/spells/poison-vial.png", description: "Throw a caustic vial.", damage: 16, range: 10, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/healing-cross.png", description: "Restore health and absorb damage.", block: 16, heal: 6, cost: 2 }), archetype: "alchemist" },
  artificer: { ...kit(2, 5.2, { icon: "assets/ui/icons/spells/lightning-bolt.png", description: "Fire a clockwork rivet.", damage: 20, range: 10, cost: 0, duration: .25 }, { icon: "assets/ui/icons/spells/protective-ward.png", description: "Deploy a barrier plate.", block: 28, cost: 3 }), archetype: "artificer" },
};
