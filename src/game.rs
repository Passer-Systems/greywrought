...
pub struct ForestThreatView {
    ...
    pub intent_reach: f64,
    pub intent_damage: f64,
    pub last_action_hit: bool,
    pub last_action_target: [f64; 2],
}
...
pub struct Game {
    ...
    pub connected: bool,
    pub resource_remaining: f64,
    pub ritual_called: bool,
    pub carried_relics: f64,
    pub banked_relics: f64,
    pub action_cooldown: f64,
    pub guard_remaining: f64,
    pub selected_threat: String,
...
pub struct Threat {
    ...
    pub active: bool,
    pub intent_stage: u8,
    pub intent_remaining: f64,
    pub intent_preparation: String,
    pub intent_action: String,
    pub intent_damage: f64,
    pub intent_noise: f64,
    pub intent_reach: f64,
    pub benefit: String,
    pub action_sequence: u64,
    pub last_action_hit: bool,
...
pub struct Tuning {
    pub move_speed: f64,
    pub gather_yield: f64,
    pub gather_presence: f64,
    pub gather_cooldown: f64,
    pub gather_damage: f64,
    pub resource_per_expedition: f64,
    pub ritual_cost: f64,
    pub ritual_presence: f64,
    pub ritual_cooldown: f64,
    pub passive_presence: f64,
    pub movement_presence: f64,
    pub party_movement_presence: f64,
    pub strike_presence: f64,
    pub party_strike_presence: f64,
    pub base_strike_cooldown: f64,
    pub party_damage: f64,
    pub relic_damage: f64,
    pub brace_cooldown: f64,
    pub brace_duration: f64,
    pub guard_multiplier: f64,
    pub intent_duration: f64,
