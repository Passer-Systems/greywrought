...
export function createInnPanel(
  ...
  panel.innerHTML = `
    <style>
      ...
      #inn-panel .inn-health { color:#c8dfd7; font-size:var(--ui-font-body); }
      #inn-rest { color:#ffe6b8; border:2px ridge #938561; border-radius:3px; background:#594832; padding:10px 12px; font:600 var(--ui-font-body) system-ui,sans-serif; cursor:pointer; }
