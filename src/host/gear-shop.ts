...
export function createGearShop(host: HTMLElement, experienceHost: HTMLElement, callbacks: { onBuy(vendor: VendorId, item: GearItemId): void; onClose(): void }) {
  ...
  style.textContent = `
    ...
    #experience-hud output { position:absolute; bottom:calc(100% + 64px); left:0; right:0; text-align:center; color:#ffe39a; font-weight:700; }
  `;
